...
class Dashboard extends CI_Controller
{
	...
	function tracking_chauffeur_filtres(){
		...
		$get_data_arret = $this->Model->getRequete('SELECT latitude,longitude FROM tracking_data WHERE ignition=0 and md5(device_uid) ="'.$CODE.'" '.$critere.' GROUP BY CAST(latitude as decimal(10,2)),cast(longitude as decimal(10,2))');
	 ...
	 // print_r($get_data_arret);die();
		...
		if(!empty($get_data_arret)){
			...
			foreach ($get_data_arret as $value_get_arret) {
				...
				$my_select_date_compare2 = $this->getBindParms('tracking_data.date', 'tracking_data', 'id >'.$one_element['id'].' AND ignition=1', 'id ASC');
			...
			if (!empty($tabl)) {
				foreach ($tabl as $keytabl) {
					...
					// <div class='jss503'>
					// <div class='jss509'>
					// <div class='jss511'><sup class='jss507'> 21 Mar</sup><span class='jss510 jss512'>11 44<span class='jss494'>:44&nbsp;</span></span><span class='jss517'>Karandini Road, Nairobi</span></div><div class='jss513'> 10M 20S<span style='float: right;'>1.31 km</span></div><div class='jss511'><sup class='jss507'> 21 Mar</sup><span class='jss510 jss514'>11 34<span class='jss494'>:24</span></span><span class='jss518'>Ngong Road, Riruta, Nairobi</span>
					// </div>
					// </div>
					// </div>
					// </div>
					...
					// $card_card.="<div class='jss491'>
                    //   <div class='jss492' style='cursor: pointer;'>
                    //   <div class='jss516'>
                    //   <div class='jss495' style='width: 78px; font-size: 11px; color: rgb(191, 195, 198); font-weight: 500;'><p><sup class='jss507 jss508'> 21 Mar</sup>11 55<span class='jss494'>:53</span></p><span style='jss494'></span><p style='position: relative;'><sup class='jss507 jss508' style='top: -13px;'>21 Mar</sup>11 44<span class='jss494'>:44&nbsp;</span></p></div>
                    //   <div class='jss495 jss496' style='width: 61%;'><span class='jss517' style='width: unset; padding: 0px;'>Karandini Road, Nairobi</span><p class='jss497'>PARKED FOR  11M 9S</p></div>
                    //   </div>
                    //   </div>
                    //   </div>";
					$v++;
