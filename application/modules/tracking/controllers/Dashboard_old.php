			...
			if (!empty($tabl)) 
			{
				...
				foreach ($tabl as $keytabl) 
				{
					...
					if($keytabl[16]==1){
						...
						$valeur_ceinture='<label style="color:red">OFF</label>';
					...
					if($keytabl[17]==1){
						...
						$valeur_clim='<label style="color:red">OFF</label>';
					...
					$my_selectprovinces=str_replace('\"', '', $my_selectprovinces);
					$provinces_delim = $this->ModelPs->getRequeteOne($proce_requete, $my_selectprovinces);
					$limites='';
