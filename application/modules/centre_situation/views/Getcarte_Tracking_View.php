...
<script>
	...
	for (var i = 0; i < (donn.length)-1; i++) 
	{
		...
		marker.bindPopup ('<div class="row" style="width:400px;"><div class="col-md-4"><img src="<?= base_url()?>/upload/photo_vehicule/'+ index[10] +'" style="width: 135px;height: 135px;border-radius: 10px; margin-top:25px;margin-left:5px; cursor:pointer;" class="  " onclick = "show_image('+index[0]+');"></div> <div class="col-md-8"> <table class="table table-borderless" style="position:relative;left:6%;top:10%;"> <tr> <td class="text-muted small pt-2 ps-1">Chauffeur<br><a href="<?= base_url()?>chauffeur/Chauffeur_New/Detail/'+index[18]+'" class="" style="" title="Détail chauffeur"><img src="<?= base_url()?>/upload/chauffeur/'+ index[20] +'" style="width: 15px;height: 15px;border-radius: 50%;" class="zoomable-image" title="Chauffeur">&nbsp;&nbsp;'+index[12]+'</a><br>Propriétaire<br><a href="<?= base_url()?>proprietaire/Proprietaire/Detail/'+index[17]+'" class="" style="" title="Détail propriétaire"><img src="<?= base_url()?>/upload/proprietaire/photopassport/'+ photo_pro +'" style="width: 15px;height: 15px;border-radius: 50%;" class="zoomable-image" title="Propriétaire">&nbsp;&nbsp;'+index[9]+'</a><br>Plaque<br><i class="text-muted small pt-2 ps-1 fa fa-credit-card"></i>&nbsp;&nbsp;'+ index[6] +'</td> </tr>  </table> </div> </div>  <p class="text-center text-muted small " style=" "> <a href="<?= base_url()?>tracking/Dashboard/tracking_chauffeur/'+index[11]+'" class="info_trajet fa fa-map-marker" style="border-radius:20px;padding:10px;" title="Informations trajet"><br><label class="info_trajet small " id="place"></label> <br><br> <font class="text-success">Voir le Résumé du parcours </font> </a></p> ',{maxWidth : 5000});
