...
<head>
	...
	<style>
		...
		.zoomable-image:hover {
			...
			#photo-container {
				width: 100%; /* Largeur de la zone de visualisation */
				height: 100%; /* Hauteur de la zone de visualisation */
				overflow: hidden; /* Masquer les parties de la photo en dehors de la zone */
				position: relative; /* Pour positionner correctement la photo */
			}

			#phot_v {
				width: 100%; /* Pour s'adapter à la largeur du conteneur */
				height: 100%; /* Pour s'adapter à la hauteur du conteneur */
	...
	<body onclick = "">
      ...
      <div class="modal fade" id="Modal_photo_vehicule" tabindex="-1">
      		...
      		<div class="modal-content">
      			...
      			<div class="modal-body">
      				...
      				<div class="row">
      					...
      					<div class="col-md-12" id="photo-container">
