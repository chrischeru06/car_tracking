...
Rapport vchauffeurs par statut
tel:71379943
*/
class Dashboard_Chauffeur extends CI_Controller
{
  ...
  function index()
  {
    $this->load->view('Dashboard_Chauffeur_View');
  }
  ...
  public function get_rapport()
  {
                     ...
                     click: function()
                     {
                      $(\"#titre1\").html(\"LISTE DES CHAUFFEUR \");
                       ...
                       $(\"#mytable\").DataTable({
                        ...
                        \"oreder\":[],
                        \"ajax\":{
                          url:\"".base_url('rapport/Dashboard_Chauffeur/detail_chof_statut')."\",
                          type:\"POST\",
                          data:{
    ...
    foreach ($chauffeur_statut as  $value) 
    {
      $color=$this->getcolor();
      $total2+=$value['NBR'];
      $key_id2=($value['ID']>0) ? $value['ID'] : "0" ;
      $somme2=($value['NBR']>0) ? $value['NBR'] : "0" ;
      $donnees2.="{name:'".$value['statut']." :". $somme2."', y:". $somme2.",color:'".$color."',key2:'". $key_id2."'},";
    }
       ...
       columnpyramid: 
       {
         ...
         point:
         {
           events: 
           {
             click: function()
             {
               $(\"#titre\").html(\"LISTE DES CHAUFFEURS\");
               $(\"#myModal\").modal('show');
               var row_count ='1000000';
               $(\"#mytable\").DataTable({
               \"processing\":true,
               ...
               \"oreder\":[],
               \"ajax\":{
               url:\"".base_url('rapport/Dashboard_Chauffeur/detail_chof_affect')."\",
               type:\"POST\",
               data:
               {
                 key2:this.key2,
