                ...
                <!-- <div class="row"> -->
                 <form enctype="multipart/form-data" name="myform" id="myform" method="POST" class="form-horizontal" action="<?= base_url('proprietaire/Proprietaire_chauffeur/add'); ?>" >
                  ...
                  <div class="row">
                   ...
                   <div class="col-md-4">
                      <label for="genre" class="text-dark" style="font-weight: 1000; color:#454545">Propriétaire <font color="red">*</font></label>
...
<script>
  ...
  function submit_form()
  {
    ...
    if($('#PROPRIETAIRE_ID').val()==''){
      statut=2;
      $('#error_PROPRIETAIRE_ID').text("Le champ est obligatoire");
    }
