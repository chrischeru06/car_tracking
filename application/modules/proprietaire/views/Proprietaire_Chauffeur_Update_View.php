          ...
          <div class="text-left col-sm-12">
            <div class="card">
              ...
              <div class="card-body text-left">
                ...
                <!-- <div class="row"> -->
                   <form enctype="multipart/form-data" name="myform" id="myform" method="post" class="form-horizontal" action="<?= base_url('proprietaire/Proprietaire_chauffeur/update'); ?>" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                      <label for="genre" class="text-dark" style="font-weight: 1000; color:#454545">Proprietaire <font color="red">*</font></label>
                      <select class="form-control" name="PROPRIETAIRE_ID" id="PROPRIETAIRE_ID">
                       ...
                       {
                        if ($value['PROPRIETAIRE_ID'] ==$membre['PROPRIETAIRE_ID'])
                          {
                            ?>
