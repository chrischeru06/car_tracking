  ...
  function liste()
  {
    ...
    // var row_count ="1000000";
      ...
      $("#mytable").DataTable({
        ...
        "oreder":[[ 0, 'desc' ]],
        "ajax":{
          url:"<?php echo base_url('chauffeur/Chauffeur_New/listing');?>",
          type:"POST", 
        },
...
<script>
...

  {
    ...
    $.ajax(
    {
      ...
      url: "<?= base_url() ?>chauffeur/Chauffeur_New/get_all_voiture/",
  ...
  function save_vehicule()
  {
    ...
    if(statut<2)
    {
      ...
      var url="<?= base_url('chauffeur/Chauffeur_New/save_voiture')?>";
      $.ajax(
      {
        url: url,
        type: 'POST',
        ...
        success: function(data)
        {
          if(data==1)
          {
            ...
            {
              window.location.reload("<?=base_url('chauffeur/Chauffeur_New')?>");
            });
          }
          else if(data==2)
          {
...

  {
    ...
    $.ajax(
    {
     url: "<?= base_url() ?>chauffeur/Chauffeur_New/get_zone_affect/"+CHAUFFEUR_ID,
  ...
  function save_modif_chauffeur()
  {
    ...
    if(statut<2)
    {
      ...
      var url="<?= base_url('chauffeur/Chauffeur_New/save_modif_chauff')?>";
      $.ajax(
      {
        url: url,
        type: 'POST',
  ...
  // Get the output text
    ...
    $.ajax(
    {
      url:"<?=base_url()?>chauffeur/Chauffeur_New/active_desactive/"+status+'/'+CHAUFFEUR_ID,
      type: 'POST',
      dataType:'JSON',
      data: form_data ,
      contentType: false,
      ...
      success: function(data)
      {
        window.location.href='<?=base_url('')?>chauffeur/Chauffeur_New';
  ...
  //STATUT_VEHICULE:debut tester si le chauffeur a une voiture pour le desactiver
    ...
    {
      var url="<?= base_url('chauffeur/Chauffeur_New/retirer_voiture')?>";
      $.ajax(
      {
        url: url,
        type: 'POST',
