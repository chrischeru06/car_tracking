...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="col-md-2">
      ...
      <a class="btn btn-outline-primary rounded-pill" href="<?=base_url('chauffeur/Chauffeur_New')?>" class="nav-link position-relative"><i class="bi bi-plus"></i> <?=lang('title_list')?></a>
          ...
          <div class="text-left col-sm-12">
            <div class="card">
              ...
              <div class="card-body text-left">
                ...
                <!-- <div class="row"> -->
                   <form enctype="multipart/form-data" name="myform" id="myform" method="POST" class="form-horizontal" action="<?= base_url('chauffeur/Chauffeur_New/add'); ?>" >

                  <div class="row">
                    <div class="col-md-4">
                      <label for="FName" class="text-dark" style="font-weight: 1000; color:#454545"><?=lang('input_nom')?> <font color="red">*</font></label>
                      <input type="text" name="nom" autocomplete="off" id="nom" value="<?= set_value('nom') ?>" placeholder="<?=lang('input_nom')?>"  class="form-control">
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="text" name="prenom" autocomplete="off" id="prenom" value="<?= set_value('prenom') ?>" placeholder="<?=lang('input_prenom')?>" class="form-control">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" name="adresse_physique" autocomplete="off" id="adresse_physique" placeholder="<?=lang('input_adresse')?>/<?=lang('mot_rue')?>" value="<?= set_value('adresse_physique') ?>"  class="form-control">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" name="adresse_email" id="adresse_email" value="<?= set_value('adresse_email') ?>" placeholder="<?=lang('input_email')?>" class="form-control">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" name="CONFIRMATION_EMAIL" id="CONFIRMATION_EMAIL" value="<?=set_value('CONFIRMATION_EMAIL') ?>" placeholder="<?=lang('input_conf_mail')?>" class="form-control" onpaste="return false;">
                  ...
                  <div class="col-md-4" class="text-dark">
                    ...
                    id="NUMERO_CARTE_IDENTITE" value="<?= set_value('NUMERO_CARTE_IDENTITE') ?>"  class="form-control" placeholder="<?=lang('n_identite')?>">
                  ...
                  <div class="col-md-4">
                    ...
                    id="NUMERO_PERMIS" value="<?= set_value('NUMERO_PERMIS') ?>" placeholder="<?=lang('n_permis_conduire')?>" class="form-control">
                 ...
                 <!--  <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                    <label for="FName" class="text-dark" style="font-weight: 1000; color:#454545"><?=lang('phto_permis_conduire')?> (.png,.jpg,.jepg)  <font color="red">*</font></label>
  ...
  <script>
     ...
     function get_communes()
    {
      ...
      else
      {
        ...
        $.ajax(
        {
          url:"<?=base_url()?>chauffeur/Chauffeur_New/get_communes/"+PROVINCE_ID,
          type:"GET",
          dataType:"JSON",
          success: function(data)
          {
    ...
    function get_zones()
    {
      ...
      else
      {
        ...
        $.ajax(
        {
          url:"<?=base_url()?>chauffeur/Chauffeur_New/get_zones/"+COMMUNE_ID,
          type:"GET",
          dataType:"JSON",
          success: function(data)
          {
    ...
    function get_collines()
    {
      ...
      else
      {
        $.ajax(
        {
          url:"<?=base_url()?>chauffeur/Chauffeur_New/get_collines/"+ZONE_ID,
          type:"GET",
          dataType:"JSON",
          success: function(data)
          {
   ...
   <script type="text/javascript">
    function verif_date()
    {
      ...
      $.ajax(
          {
            type: "POST",
            url:"<?=base_url()?>chauffeur/Chauffeur_New/verif_date/",
            dataType: 'JSON',
            data:{
