<header id="header" class="header fixed-top d-flex align-items-center"  style="background-color: rgb(21, 22, 197);">

  <div class="d-flex align-items-center justify-content-between">
    <a href="<?= base_url()?>/template/Dashboard.php" class="logo d-flex align-items-center">
      <img src="<?= base_url()?>upload/Car_tracking_png-03.png" alt="" >
      <span class="d-none d-lg-block text-light">MediaTracking</span>
    </a>
      ...
      <li class="nav-item dropdown pe-3">
        ...
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
          ...
          if (!empty($photo['PHOTO_PASSPORT'])) 
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2 text-light"><?=$this->session->userdata('IDENTIFICATION')?></span>
