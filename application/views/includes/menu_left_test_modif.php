<style type="text/css">
  #link_menu{
    background-color: rgb(47, 88, 169);
  }
</style>
...
if ($this->session->PROFIL_ID == 1) {
  ...
  <!-- <aside id="sidebar" class="sidebar" style="background-color: cadetblue; background-size: cover; background-repeat: no-repeat;background-image: url('<?php //echo base_url().'template/images/sidebar123-01s.png'; ?>')"> -->
    ...
    <aside id="sidebar" class="sidebar" style="background: linear-gradient(0deg, rgba(0,3,36,0.958420868347339) 1%, rgba(15,15,200,0.9724264705882353) 100%);">

    <ul class="sidebar-nav" id="sidebar-nav" >

     <li class="nav-item">
      <a class="nav-link text-light" href="<?=base_url()?>centre_situation/Centre_situation" id="link_menu">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed text-light" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#" id="link_menu">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed text-light" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#" id="link_menu">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed text-light" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#" id="link_menu">
